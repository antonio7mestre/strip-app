...
function BlockSelectionCorners() {
  return (
    <span className="block-selection-corners" aria-hidden="true">
  ...
  return (
    ...
    >
      <video
        ...
        draggable={false}
      />
      {isEditing && isSelected ? <BlockSelectionCorners /> : null}
      <button
